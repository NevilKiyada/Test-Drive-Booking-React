...
//         ) : cars.length === 0 ? (
//           <p className="text-gray-500">No cars available in this showroom.</p>
//         ) : (
//           <div className="mt-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
//             {cars.map((car) => (
//               <div key={car._id} className="bg-white overflow-hidden shadow rounded-lg">
//                 <div className="relative h-48">
//                   <img
...
//                   </div>
//                   <div className="mt-4">
//                     <Link to={`/cars/${car._id}`} className="btn-primary inline-block">
//                       View Details
//                     </Link>
//                   </div>
//                 </div>
